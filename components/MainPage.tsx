      ...
      <div className="relative z-10 flex flex-col h-full p-6 text-center text-white">
        <div className="mt-auto">
          ...
          <div className="space-y-2">
            {/* MODIFICADO: Estilo do botão "Ver Detalhes" atualizado */}
            ...
            {/* MODIFICADO: Estilo do botão "Contratar" atualizado */}
        ...
        <section id="home" className="min-h-screen flex items-center justify-center text-center relative overflow-hidden">
          ...
          <div className="relative z-20 p-6 flex flex-col items-center h-screen w-full max-w-4xl mx-auto pt-32 pb-16">
            ...
            <div className="grid grid-cols-2 gap-4 w-full max-w-md my-auto">
              {/* MODIFICADO: Estilo dos cards restaurado para 'vidro fosco' */}
